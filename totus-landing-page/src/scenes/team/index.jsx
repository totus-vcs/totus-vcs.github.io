...
const Team = () => {
    return <section class="container py-5 my-md-3 my-lg-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            ...
            <TeamMemberIcon name="Evangeline Sturges" role="Project Co-Lead" imageLoc="assets/img/team/evangeline.jpg" linkedInUrl="#" />
        ...
        <div class="row align-items-center mt-4 mb-5">
            ...
            <TeamMemberIcon name="Yuqi Wu" role="Mechanical Lead" imageLoc="assets/img/team/04.jpg" linkedInUrl="#"/>   
