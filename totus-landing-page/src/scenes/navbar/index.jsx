...
const Navbar = () => {
    return <div class="header navbar navbar-expand-lg position-absolute navbar-sticky">
        <div class="container px-3">
            <a href="index-2.html" class="navbar-brand pe-3">
                <img
                    ...
                    alt="Silicon"
                />
                <img src="assets/img/TotusText.png" width="140" alt="Silicon" />
            </a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <div class="d-lg-flex">
                                    ...
                                    <div class="mega-dropdown-column pt-lg-3 pb-lg-4">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li>
                                                <a
                                                    href="landing-software-company.html"
                                                    class="dropdown-item"
                                                >
                                                    IT (Software) Company
                                                </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="account-details.html" class="dropdown-item">
                                        Account Details
                                    </a>
                                </li>
                                <li>
                                    <a href="account-security.html" class="dropdown-item">
                                        Security
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="account-messages.html" class="dropdown-item">
                                        Messages
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="account-payment.html" class="dropdown-item">
                                        Payment Details
                                    </a>
                                </li>
                                <li>
                                    <a href="account-signin.html" class="dropdown-item">
                                        Sign In
                                    </a>
                                </li>
                                <li>
                                    <a href="account-signup.html" class="dropdown-item">
                                        Sign Up
                                    </a>
                                </li>
                            </ul>
